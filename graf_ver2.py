...
def categorize_kano_and_plot(innovations):
    ...
    folder_name = str(uuid.uuid4())  # Генерируем уникальный идентификатор для имени папки
    os.makedirs(folder_name, exist_ok=True)  # Создаем папку, если она не существует
