...
def categorize_kano_and_plot(innovations, output_file='kano_results.csv', plot_file='kano_plot.png'):
    """
    ...
    :param output_file: Имя файла для сохранения результатов в формате CSV с разделителем ';'.
    :param plot_file: Имя файла для сохранения графика.
